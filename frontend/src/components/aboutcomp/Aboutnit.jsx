...
const Aboutnit = () => {
  return (
    <div className='flex w-full justify-center items-center flex-col mt-4'>
      <section className="py-16 bg-white rounded-xl shadow-lg max-w-7xl px-4 lg:px-8">
        ...
        <p className="text-black text-base md:text-lg lg:text-xl xl:text-2xl leading-relaxed">
          ...
          </strong>, in the river Ganges is a significant historical event. The campus has a picturesque river view with historic buildings, presenting a spectacle of architectural delight and natural beauty.
        </p>

        <p className="text-black text-base md:text-lg lg:text-xl xl:text-2xl mt-4 leading-relaxed">
          <strong className="text-black">National Institute of Technology Patna</strong> has been declared as an Institute of National Importance and has been granted fully Autonomous Status by MHRD, Government of India. The Institute has also been declared as a Centre of Excellence, imparting high-level education, training, research, and development in science, engineering technology, and humanities.
        </p>
