...
const UpdateIndustryProgrammeMember = () => {
  ...
  useEffect(()=>{
    async function getData(){
        setLoading(true);
        try {
          const res=await axios.get(`${import.meta.env.VITE_API_URL}/industryprogramme/getMember/${id}`,{
    ...
    try {
      ...
      if (imageResponse.data.result) {
        const response = await axios.put(
          `${import.meta.env.VITE_API_URL}/industryprogramme/updateMember/${id}`,
...
export default UpdateIndustryProgrammeMember;
