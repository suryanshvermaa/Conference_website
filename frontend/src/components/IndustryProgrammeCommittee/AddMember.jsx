...
const AddIndustryProgrammeCommitteeMember = () => {
    ...
    try {
      ...
      if (imageResponse.data.result) {
        const response = await axios.post(
          `${import.meta.env.VITE_API_URL}/industryprogramme/createMember`,
        ...
        if (response.status === 201) {
          ...
          setImage(null);
          setOrganisingMemberData({name:"",description:"",imageUrl:"",specialization:"",college:"",committee:""})
        }
      }
    } catch (error) {
    ...
    <div className="mx-auto w-full max-w-3xl">
      <div className="admin-card">
        <div className="admin-card-inner">
          <div className="mb-6">
            <h2 className="admin-title">Add Industry Programme Committee Member</h2>
            <p className="admin-muted mt-1">Create a new industry programme committee profile.</p>
          </div>
...
export default AddIndustryProgrammeCommitteeMember;
