...
export default function Navbar(fetch, setfetch) {
  ...
  const menuSections = [
    ...
    { label: "Authors", key: "authors", options: ["Call for Papers", "Guidelines to Authors", "Paper Submissions", "Registrations", "Best Student Paper Award", "Best Paper Awards", "Financial support", "CMT Acknowledgement", "Paper Publication"] },
