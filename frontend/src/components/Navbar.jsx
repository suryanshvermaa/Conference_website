...
export default function Navbar(fetch, setfetch) {
  ...
  const menuSections = [
    ...
    { label: "Authors", key: "authors", options: ["Call for Papers","Paper Publication","Guidelines to Authors",,"Paper Submissions", "Registrations","Best Student Paper Award" ,"Financial support","CMT Acknowledgement"] },
