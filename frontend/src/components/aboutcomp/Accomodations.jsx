...
const Accomodations = () => {
  return (
    <div className='flex w-full justify-center items-center flex-col'>
      <div className="mt-8 py-16 bg-white rounded-xl shadow-lg max-w-5xl px-4 lg:px-8">
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-black mb-6 border-b-4 border-blue-500 w-full text-center">
          Accommodation
        </h2>

        {/* Guest House and Hostels */}
        <h3 className="text-lg md:text-xl lg:text-2xl font-semibold text-black mt-4">• Guest House and Hostels</h3>
        <p className="text-black text-base md:text-lg lg:text-xl leading-relaxed mt-2">
        ...
        {/* Nearby Hotels */}
        <h3 className="text-lg md:text-xl lg:text-2xl font-semibold text-black mt-6">• Nearby Hotels</h3>
        <p className="text-black text-base md:text-lg lg:text-xl leading-relaxed mt-2">
        ...
        {[
          ...
          <div key={index} className="mt-10">
            <h4 className="text-base md:text-lg lg:text-xl font-semibold text-black mb-2">{hotel.name}</h4>
